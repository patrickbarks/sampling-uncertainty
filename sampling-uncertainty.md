...
<img src="img/fig_1.png" width="500px" />

   

#### 3. Subset COMPADRE to populations of interest, and calculate life expectancy (l<sub>0</sub>) and variance(log λ)
...
#### 4. Model relationship between l<sub>0</sub> and var(log λ), assuming zero measurement error
...
#### 5. Model sampling uncertainty in transition rates and derived parameters for *Agrimonia eupatoria* population 'B' from [Kiviniemi (2002)](https://doi.org/10.1023/A:1015506019670)
...
#### 6. Add error bars for *Agrimonia eupatoria* population 'B' to initial plot
...
#### 7. Redo regression analysis with simulated measurement error in l<sub>0</sub> and var(log λ)
