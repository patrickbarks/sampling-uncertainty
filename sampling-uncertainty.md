Sampling uncertainty in projection matrices
================
Patrick Barks
2018-05-29
...
#### 2. Subset COMPADRE to populations of interest, and calculate life expectancy (l<sub>0</sub>) and variance(log λ)
...
# subset to populations with at least 3 annual matrices; matA must be ergodic,
#  matU/matF must not be constant over all years, lambda != 0
...
#### 3. Model relationship between l<sub>0</sub> and var(log λ), assuming zero measurement error
...
#### 4. Model sampling uncertainty in transition rates and derived parameters for *Agrimonia eupatoria* population 'B' from [Kiviniemi (2002)](https://doi.org/10.1023/A:1015506019670)
...
#### 5. Add error bars for *Agrimonia eupatoria* population 'B' to initial plot
...
#### 6. Redo regression analysis with simulated measurement error in l<sub>0</sub> and var(log λ)
